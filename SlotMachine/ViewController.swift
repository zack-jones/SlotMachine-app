...
class ViewController: UIViewController {
    ...
    func setupFourthContainer (containerView: UIView) {
        ...
        self.resetButton.setTitleColor(UIColor.yellowColor(), forState: UIControlState.Highlighted)
        ...
        self.betOneButton.setTitleColor(UIColor.yellowColor(), forState: UIControlState.Highlighted)
        ...
        self.betMaxButton.setTitleColor(UIColor.yellowColor(), forState: UIControlState.Highlighted)
        ...
        self.spinButton.setTitleColor(UIColor.yellowColor(), forState: UIControlState.Highlighted)
